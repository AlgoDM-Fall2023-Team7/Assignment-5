...
def Image_Match():
    ...
    def load_vgg19_model():
        ...
        vgg.load_weights("D:\\University\\Sem 3\\Algorithmic Digital Marketing\\ADM Asgn 5\\Archive (7)\\vgg19_weights.h5")
        return vgg
...
def Image_Search_by_Text():
    ...
    openai.api_key = "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"  # Replace with your actual OpenAI API key
    ...
    def search_similar_images(query):
        serpapi_key = "f416556a9633a90e4fb7268ea4248db84db712485e56a88c186c0ea4d4637445"  # Replace with your actual SerpApi key
        params = {
            "q": query,
